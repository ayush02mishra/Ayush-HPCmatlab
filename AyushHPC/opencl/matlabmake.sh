...
Files=./source/*.c
mexcompiler="CC=gcc"
export AMDAPPSDKROOT="/home/amishr24/AMDAPPSDK-3.0"
export OPENCL_VENDOR_PATH="/home/mhdave1/libs/AMDAPPSDK-3.0/etc/OpenCL/vendors/"
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:"/home/mhdave1/libs/AMDAPPSDK-3.0/lib/x86_64/"
for file in $Files
do
    echo $file
