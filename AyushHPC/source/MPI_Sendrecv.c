/*
	...
	http://www.mpich.org/static/docs/latest/www3/MPI_Sendrecv.html
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	if(nrhs!=10) 
	{
		mexErrMsgIdAndTxt("HPCmatlab:MPI_Sendrecv:nrhs","10 inputs required.");
	}
	if(nlhs!=3) 
	{
		mexErrMsgIdAndTxt("HPCmatlab:MPI_Sendrecv:nlhs","3 output required.");
	}
	 ...
	 switch(*((MPI_Datatype *)mxGetData(prhs[2])))
{
        ...
        break;
        default:
        mexErrMsgIdAndTxt("HPCmatlab:MPI_Sendrecv:MPI_DATATYPE","Incompatible Datatype");
}
	 int m =1,n =1;
        int nfields = 5;
